...
class MoneyControllerTest < ActionController::TestCase
  ...
  test "should create money" do
    assert_difference('Money.count') do
      post :create, money: { category_id: @money.category_id, date: @money.date, family_id: @money.family_id, loginuser_id: @money.loginuser_id, price: @money.price }
    end
  ...
  test "should update money" do
    patch :update, id: @money, money: { category_id: @money.category_id, date: @money.date, family_id: @money.family_id, loginuser_id: @money.loginuser_id, price: @money.price }
    assert_redirected_to money_path(assigns(:money))
  end
